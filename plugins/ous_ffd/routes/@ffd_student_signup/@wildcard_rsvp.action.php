...
printf('<p><strong>Shirt size:</strong> %s</p>', $rsvp['shirt']);

printf('<p><strong>Expected guests:</strong> %s</p>', $rsvp['guest_count']);
if ($rsvp['guest_email']) printf('<p><strong>Guest email:</strong> %s</p>', $rsvp['guest_email']);
if ($rsvp['alumni_parents']) printf('<p><strong>Alumni parents:</strong> %s</p>', $rsvp['alumni_parents']);
